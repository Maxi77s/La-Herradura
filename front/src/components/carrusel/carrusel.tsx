...
const services: Service[] = [
  {
    ...
    description: "Ofrecemos variadas bebidas y comidas para cualquier tipo de evento.",
...
const ServiceCarousel: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 pb-20 relative">
